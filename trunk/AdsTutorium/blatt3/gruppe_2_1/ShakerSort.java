...
public class ShakerSort {
	...
	static void shakerSort(int[] array) {
		...
		boolean swapped = true; // variable to check if two elements were swapped
		
		boolean fromTheFront = true; // variable to determine the direction of sorting
		
		int numberOfPermutations = 0;
		int numberOfComparisons = 0;
		
		// as long as two elements were swapped, you have to check the order once again
		while(swapped) {
