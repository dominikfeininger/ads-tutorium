...
public class Komplexitätsexperiment {
	...
	static int binarySearchRecursive (int array[], int searchKey, int lowerBound, int upperBound) {
		...
		// go on in the lower side
			...
			// recusive calling with middle-1 as upperBound and return result + 1
			return binarySearchRecursive(array, searchKey, lowerBound, middle-1) + 1;
			
		// go on in the upper side
		else if (searchKey > array[middle] && lowerBound<=upperBound)
			// recusive calling with middle+1 as lowerBound and return result + 1
			return binarySearchRecursive(array, searchKey, middle+1, upperBound) + 1;
...
// linear search (last hit)		
		...
		println("linear search (last hit) with 1024 elements: " + average/numberOfCallings);
...
// linear search (first hit)	
		...
		println("linear search (last hit) with 2048 elements: " + average/numberOfCallings);
		...
		println("linear search (last hit) with 4096 elements: " + average/numberOfCallings);
...
// binäre Suche	(iterativ)	
		...
		println("binary search (iterative) with 1024 elements: " + average/numberOfCallings);	
		...
		println("binary search (iterative) with 2048 elements: " + average/numberOfCallings);
		...
		println("binary search (iterative) with 4096 elements: " + average/numberOfCallings);
...
// binäre Suche Rekursiv
		...
		while (numberOfCallings<100) {
			...
			average += binarySearchRecursive(array1, searchKey1, 0, array1.length);
			numberOfCallings++;
		}
		println("binary search (recursive) with 1024 elements: " + average/numberOfCallings);
		...
		while (numberOfCallings<100) {
			...
			average += binarySearchRecursive(array2, searchKey2, 0, array2.length);
			numberOfCallings++;
		}
		println("binary search (recursive) with 2048 elements: " + average/numberOfCallings);
		...
		while (numberOfCallings<100) {
			...
			average += binarySearchRecursive(array3, searchKey3, 0, array3.length);
			numberOfCallings++;
		}
		println("binary search (recursive) with 4096 elements: " + average/numberOfCallings);
...
// linear search (first hit)
		...
		println("linear search (first hit) with 1024 elements: " + average/numberOfCallings);
		...
		println("linear search (first hit) with 2048 elements: " + average/numberOfCallings);
		...
		println("linear search (first hit) with 4096 elements: " + average/numberOfCallings);
...
// binary search (recursive)
		...
		while (numberOfCallings<100) {
			...
			average += binarySearchRecursive(array1, array1.length/2, 0, array1.length);
			numberOfCallings++;
		}
		println("binary search (recursive) with 1024 elements: " + average/numberOfCallings);
		...
		while (numberOfCallings<100) {
			...
			average += binarySearchRecursive(array2, array2.length/2, 0, array2.length);
			numberOfCallings++;
		}
		println("binary search (recursive) with 2048 elements: " + average/numberOfCallings);
		...
		while (numberOfCallings<100) {
			...
			average += binarySearchRecursive(array3, array3.length/2, 0, array3.length);
			numberOfCallings++;
		}
		println("binary search (recursive) with 4096 elements: " + average/numberOfCallings);
